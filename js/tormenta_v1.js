...
function tormenta() {
    ...
    posX2 = limit - 15 * unit;
    posXX = limit + 15 * unit;
    posXX2 = limit + 15 * unit;*/

    // txell
    posChunga = limit + 3*unit
...
function rain() {
    ...
    class Heart {
        constructor() {
            this.scale = 0.2;
            this.x = getRandomNumber(0 * unit + posChunga, 15 * unit + posChunga);
        ...
        reset = () => {
            if (this.y > canvas.height) {
                this.y = 7.4 * unit;
                this.x = getRandomNumber(1 * unit + posChunga, 14 * unit + posChunga);
                this.speedY = getRandomNumber(1, 5);
                this.cont--;
                num++;
            }
